...
class CNWNXUbab : public CNWNXBase  
{
public:
	...
	void WriteLogHeader( );
	bool BaseTypeAllowedUbab( DWORD basetype );

	bool OverwriteFunction( DWORD pCode, PVOID pCallbackFunc, PVOID *pNextHook, const char * name );

...
//	uint32_t 								cre_minimapcount;	/* 0x049C */
	...
	uint8_t									field_A52;
	uint8_t									field_A53;
	uint32_t								spellid; //field_A54; //counterspell (dword) spell-id?
	//uint8_t									field_A55;
	//uint8_t									field_A56;
	//uint8_t									field_A57;
	uint8_t									casterclass; //field_A58; //counterspell (byte) class?
	uint8_t									metamagic; //field_A59; //counterspell (byte) metamagic?
	uint8_t									arg4_something_spell_related; //field_A5A; //counterspell (byte) classindex/spellslot?
	uint8_t									field_A5B;
	uint8_t									field_A5C;
	uint8_t									field_A5D;
	uint8_t									field_A5E;
	...
	int					GetAttackModifierVersus( CNWSCreature * cre );
	double				GetSpotCheckDistance( );
	double				GetListenCheckDistance( );

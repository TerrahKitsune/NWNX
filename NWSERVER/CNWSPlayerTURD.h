...
struct CNWSPlayerTURD_s {
  ...
  unsigned __int32 TURD_PlayerID; //1D8
  unsigned __int32 TURD_CalendarDay; //1DC
  unsigned __int32 TURD_TimeOfDay; //1E0
  unsigned __int32 TURD_RepAmount; //1E4
  unsigned __int32 TURD_PersonalRep; //1E8
  CTURDMaps AreaData; //1EC

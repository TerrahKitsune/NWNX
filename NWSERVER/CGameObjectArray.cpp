...
char 	(__thiscall *CGameObjectArray__GetGameObject)(CGameObjectArray *pTHIS, unsigned int a2, CGenericObject *a3) = (char (__thiscall*)(CGameObjectArray *pTHIS, unsigned int a2, CGenericObject *a3))0x00466980;

uint8_t CGameObjectArray_s::DEL(nwn_objid_t oID) {
	return CGameObjectArray__delete(this, oID);
}

char CGameObjectArray_s::GetGameObject(unsigned int a2, CGenericObject *a3) {

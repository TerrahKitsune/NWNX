...
long double 	(__thiscall *CNWSArea__ComputeHeight)(CNWSArea *pTHIS, Vector v)=(long double (__thiscall*)(CNWSArea *pTHIS, Vector v))0x005276D0;
...
void			(__thiscall *CNWSArea__UpdatePlayerAutomaps)( CNWSArea * pThis )=(void(__thiscall*)(CNWSArea*))0x00529D90;

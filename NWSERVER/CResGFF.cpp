...
CResGFF_s *		(__thiscall *CResGFF__CResGFF2)(CResGFF *pTHIS, unsigned short type, const char * gfftype, CResRef const & resref) = (CResGFF_s *(__thiscall *)(CResGFF *, unsigned short , const char * , CResRef const & ))0x006119E0;
...
CResGFF_s * CResGFF_s::NWNX_CreateOpenAndDemand( unsigned short uType, const char * gffType,  CResRef const & ResRef ){

	CNWNXMemory mem;

	return CResGFF__CResGFF2( (CResGFF_s*)mem.nwnx_malloc( 172 ), uType, gffType, ResRef );
}
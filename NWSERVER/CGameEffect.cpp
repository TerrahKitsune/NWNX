...
int				(__thiscall *CGameEffect__UpdateLinked)(CGameEffect *pTHIS) = (int(__thiscall*)(CGameEffect *pTHIS))0x004E8470;
int				(__thiscall *CGameEffect__SetInteger)( CGameEffect *pTHIS, int a2, int a3) = (int(__thiscall *)( CGameEffect *, int, int))0x004E8140;

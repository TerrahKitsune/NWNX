...
void 				(__thiscall *CNWSCreature__UpdateAppearanceDependantInfo)(CNWSCreature *pThis) = (void (__thiscall *)(CNWSCreature* pThis))0x00A483F0;
...
int					(__thiscall *CNWSCreatureStats__GetAttackModifierVersus)(CNWSCreature * pThis, CNWSCreature * cre) = (int (__thiscall *)(CNWSCreature * pThis, CNWSCreature * cre))0x00470F00;
double				(__thiscall *CNWSCreatureStats__GetSpotCheckDistance)(CNWSCreature * pThis ) = (double (__thiscall *)(CNWSCreature *))0x004AF750;
double				(__thiscall *CNWSCreatureStats__GetListenCheckDistance)(CNWSCreature * pThis ) = (double (__thiscall *)(CNWSCreature *))0x004AF770;
void				(__thiscall *CNWSCreature__ClearVisibleList)(CNWSCreature * pThis) = (void (__thiscall *)(CNWSCreature * pThis))0x004C7F20;
void				(__thiscall *CNWSCreature__UpdateVisibleList)(CNWSCreature * pThis) = (void (__thiscall *)(CNWSCreature * pThis))0x004C7BA0;
...
int CNWSCreature_s::AddToVisibleList( nwn_objid_t obj, int a1, int a2, unsigned char a3, int a4 ){
	return CNWSCreature__AddToVisibleList( this, obj, a1,a2,a3,a4 );
}

void CNWSCreature_s::UpdateVisibleList( ){
	CNWSCreature__UpdateVisibleList( this );
}

void CNWSCreature_s::ClearVisibleList( ){
	CNWSCreature__ClearVisibleList( this );
}

double CNWSCreature_s::GetSpotCheckDistance( ){
	return CNWSCreatureStats__GetSpotCheckDistance( this );
}

double CNWSCreature_s::GetListenCheckDistance( ){
	return CNWSCreatureStats__GetListenCheckDistance( this );
}

int	CNWSCreature_s::GetAttackModifierVersus( CNWSCreature * cre ){

	return CNWSCreatureStats__GetAttackModifierVersus( this, cre );
}
...
int CNWSCreature_s::HasFeat(unsigned short nFeat) {
	return CNWSCreature__HasFeat(this, nFeat);
}

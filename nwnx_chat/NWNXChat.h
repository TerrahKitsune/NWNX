...
public:
	...
	int SendChat(char * Parameters);
	int SendMsg(int nChannel, int oSender, char * sMessage, int nRecipientID);
	int GetID(nwn_objid_t obj_id);

	void SetLastMSG(char * msg, int channel, int to);
